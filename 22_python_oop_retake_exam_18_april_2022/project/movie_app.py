...
class MovieApp:
    ...
    def found_movie(self, movie):
        found_movie = next(filter(lambda x: x.title == movie.title, self.movies_collection), None)
        return found_movie
    ...
    def upload_movie(self, username: str, movie: Movie):
        ...
        search_movie = self.found_movie(movie)
        if search_movie:
