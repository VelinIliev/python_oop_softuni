...
print(food_orders_app)
# print(chocolate_and_violets.quantity)
print(food_orders_app.add_meals_to_shopping_cart('0899999998', **food))
# print(chocolate_and_violets.quantity)
print(food_orders_app.finish_order("0899999998"))
# print(chocolate_and_violets.quantity)
print(food_orders_app)
print(food_orders_app.register_client("0899999997"))
print(food_orders_app)
print(food_orders_app.add_meals_to_shopping_cart('0899999997', **food))
print(food_orders_app.client_status("0899999997"))
print(food_orders_app.finish_order("0899999997"))
print(food_orders_app.register_client("0899999996"))
# print(food_orders_app.cancel_order("0899999996"))
print(chocolate_and_violets.quantity)
